...
'    end if
    m.top.response = {
        "record": {
            "ScreenA": {
                "logo": "https://logos-world.net/wp-content/uploads/2021/02/Spectrum-Logo-700x394.png",
                "title": "Screen A",
                "numberSet": [
                    659,
                    1986,
...
function get(url as string) as string
	...
	request.AddHeader("X-Access-Key", "$2b$10$aoACF.9P0WVp1wi8w2P.T.WuxaHxuiqzDvHAjg1WgAit2eXUKfJjy")
